...
function NotificationCard({ time, title, body }: { time: string; title: string; body: string }) {
  return (
    <div className="flex items-start gap-2.5 rounded-2xl bg-white/95 px-3 py-2.5 shadow-lift">
      <img src="/icon-192.png" className="mt-0.5 h-8 w-8 shrink-0 rounded-lg" alt="" />
